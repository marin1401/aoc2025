...
def join_ranges(first_id_check, last_id_check, id_range):
    for first_id, second_id in id_range:
        if first_id < first_id_check and second_id >= first_id_check:
            if second_id > last_id_check:
                return (first_id, second_id)
            else:
                return (first_id, last_id_check)
        elif second_id > last_id_check and first_id <= last_id_check:
